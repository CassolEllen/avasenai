    ...
    <PageTransition direction="slide">
      ...
      <div className="px-4 pt-4 pb-24">
        ...
        <motion.div
          ...
          className="bg-card rounded-2xl p-4 shadow-senai mb-4"
        >
            ...
            {days.map((day, i) => {
              ...
              return (
                <button
                  ...
                  className={`tap-feedback relative w-full aspect-square rounded-xl flex flex-col items-center justify-center text-xs font-medium transition-all ${
          ...
          <div className="space-y-2">
            {eventsForDate.map((event, i) => (
              <motion.div
                ...
                className="tap-feedback bg-card rounded-2xl p-4 shadow-senai flex items-center gap-3 cursor-pointer"
              >
        ...
        {selectedEvent && (
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-foreground">{eventLabels[selectedEvent.type]}</p>
            </div>
            <div>
